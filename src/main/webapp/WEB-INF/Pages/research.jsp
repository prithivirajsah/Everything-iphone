...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/Css/researchpage.css"/>
...
<body>
  ...
  <section class="research-content">
    <div class="box">
      <div class="website">
        <img src="${pageContext.request.contextPath}/Resources/image/sabkophone.jpg" alt="SabkoPhone">
    ...
    <div class="box">
      <div class="website">
        <img src="${pageContext.request.contextPath}/Resources/image/trustpilot.png" alt="TrustPilot">
    ...
    <div class="box">
      <div class="website">
        <img src="${pageContext.request.contextPath}/Resources/image/evostore.jpg" alt="Evo Store">
